...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.google-analytics.com https://www.googletagmanager.com https://vercel.live https://*.tawk.to giscus.app;
  style-src 'self' 'unsafe-inline' https://*.tawk.to giscus.app;
  img-src * blob: data:;
  media-src 'none';
  connect-src *;
  font-src 'self' https://*.tawk.to;
  frame-src https://vercel.live https://*.tawk.to giscus.app;
